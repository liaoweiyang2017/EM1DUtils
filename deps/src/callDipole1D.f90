...
subroutine callDipole1D(txLoc, rxLoc, freqArray, sigma1D, depth1D, &
    ...
    use dipole1d
    implicit none
	!DEC$ ATTRIBUTES DLLEXPORT :: callDipole1D
	!DEC$ ATTRIBUTES ALIAS:'calldipole1d_'::callDipole1D
...
subroutine callDipole1DEB(txLoc, rxLoc, freqArray, sigma1D, depth1D, &
    ...
    use dipole1d
    implicit none
	!DEC$ ATTRIBUTES DLLEXPORT :: callDipole1DEB
	!DEC$ ATTRIBUTES ALIAS:'calldipole1deb_'::callDipole1DEB
...
subroutine callDipole1DFinite(txLoc, rxLoc, dipLen, nP, freqArray, sigma1D, depth1D, &
    ...
    use dipole1d
    implicit none
	!DEC$ ATTRIBUTES DLLEXPORT :: callDipole1DFinite
	!DEC$ ATTRIBUTES ALIAS:'calldipole1dfinite_'::callDipole1DFinite
