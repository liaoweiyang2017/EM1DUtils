...
#
#------------------------------------------------------------------------------
export comp1DCSEM, comp1DCSEMEz
...
function comp1DCSEM(txLoc::Array{T}, rxLoc::Array{T}, freqArray::Array{T},
    ...
    ccall((:calldipole1d_, dipole1dLibPath), Nothing, (Ref{Float64}, Ref{Float64}, Ref{Float64},
                    Ref{Float64}, Ref{Float64}, Ref{Int64}, Ref{Int64}, Ref{Int64},
                    Ref{Int64}, Ref{ComplexF64}, Ref{ComplexF64}, Ref{ComplexF64}),
                    txLoc, rxLoc, freqArray, sigma, depth1D, nTx, nRx, nFreq,
                    nLayer, ex1d, ey1d, ez1d)
...
function comp1DCSEM(txLoc::Array{T,2}, rxLoc::Array{T,2},
    ...
    ccall((:calldipole1deb_, dipole1dLibPath), Nothing, (Ref{Float64}, Ref{Float64}, Ref{Float64},
                    Ref{Float64}, Ref{Float64}, Ref{Int64}, Ref{Int64}, Ref{Int64},
                    Ref{Int64}, Ref{Int64}, Ref{ComplexF64}), txLoc, rxLoc, freqArray,
                    sigma, depth1D, nTx, nRx, nFreq, nLayer, compFlag, e1d)
    println(typeof(e1d), size(e1d))
    return e1d

end # comp1DCSEM


function comp1DCSEMEz(txLoc::Array{T,2}, rxLoc::Array{T,2},
                      freqArray::Array{T}, sigma::Vector{T},
                      depth1D::Vector{T}) where{T<:Real}
    ...
    for i = 1:nRx
        rxtmpz[1, :]  = rxLoc[i, :]
        ez1d[i, :, :] = comp1DCSEM(txLoc, rxtmpz, freqArray, sigma, depth1D, 3)
    end
...
function comp1DCSEM(txLoc::Array{T}, rxLoc::Array{T}, dipLen::T,
    ...
    ccall((:calldipole1dfinite_, dipole1dLibPath), Nothing, (Ref{Float64}, Ref{Float64},
                        Ref{Float64}, Ref{Int64}, Ref{Float64}, Ref{Float64},
                        Ref{Float64}, Ref{Int64}, Ref{Int64}, Ref{Int64},
                        Ref{Int64}, Ref{Int64}, Ref{ComplexF64}), txLoc, rxLoc,
                        dipLen, nIntPts, freqArray, sigma, depth1D, nTx, nRx,
                        nFreq, nLayer, compFlag, e1d)
